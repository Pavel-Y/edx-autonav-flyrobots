...
class UserCode:
    def __init__(self):
        ...
        mx = 1
        my = 2
        #Beacon positions should be known as they are the targets for the robot
    ...
    def calculatePredictStateJacobian(self, dt, x, u_linear_velocity, u_yaw_velocity):
        ...
        dRotation_dYaw = np.array([[-s_yaw, -c_yaw],
                                   [ c_yaw, -s_yaw]])
        F = np.identity(3)
    ...
    def beacon_callback(self, active_beacon):
        ...
        sets the first of inactivated beacons as the desired robot position
        '''
